...
import (
	...
	mtmetrics "github.com/xtls/xray-core/app/metrics"
...
func (b *Balancer) PickOutbound() (string, error) {
	...
	if err != nil {
		if b.fallbackTag != "" {
			...
			mtmetrics.RecordBalancerSelected(b.tag, b.fallbackTag)
			return b.fallbackTag, nil
		}
		mtmetrics.RecordBalancerError(b.tag, mtmetrics.ClassifyError(err))
		return "", err
	}
	var tag string
	...
	if tag == "" {
		...
		mtmetrics.RecordBalancerError(b.tag, "empty")
		return "", errors.New("balancing strategy returns empty tag")
	}
	mtmetrics.RecordBalancerSelected(b.tag, tag)
	return tag, nil
}
