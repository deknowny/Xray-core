...
func (h *Handler) Dispatch(ctx context.Context, link *transport.Link) {
	...
	finishMetrics := mtmetrics.StartOutboundDispatch(h.tag, ob.Target.Network.SystemString())
	defer func() {
		finishMetrics(dispatchErr)
	}()
...
func (h *Handler) Dial(ctx context.Context, dest net.Destination) (stat.Connection, error) {
	...
	mtmetrics.ObserveOutboundDial(h.tag, dest.Network.SystemString(), err, time.Since(dialStartedAt))
